...
export default function RandomWord({
  ...
  return (
    <div className="mt-4">
      {word && (
        <div className="mb-4 rounded-2xl bg-emerald-50 px-3.5 py-2.5 text-center text-base font-medium text-slate-800">
          {lang === "en" ? (
            <>
      ...
      <div className="grid grid-cols-1 gap-2.5 lg:grid-cols-[minmax(0,1fr)_200px]">
        <div className="rounded-2xl border border-slate-200 bg-white p-2.5 text-center shadow-sm sm:p-3">
          <div className="flex min-h-[84px] flex-col items-center justify-center pt-2.5">
            <div className="text-[2.5rem] font-bold tracking-tight text-slate-900">
              {word || "—"}
            </div>

            {(ipa || pos) && lang === "en" && (
              <div className="mt-0.5 flex items-center justify-center gap-2 text-sm text-slate-500">
                {ipa && <span className="font-mono text-base text-slate-700">/{ipa}/</span>}
        ...
        <div className="relative rounded-2xl border border-slate-200 bg-white p-2.5 shadow-sm sm:p-3">
